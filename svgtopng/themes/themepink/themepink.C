...
char* PINKLADYMain::plugin_title()
{
	return "themepinkNAME";
}
...
void PINKLADY::initialize()
{
	...
	resources->text_default = ff80b2;
	resources->text_background = ff277e;
	resources->text_border1 = 0x202020;
	resources->text_border2 = ff277e;
	resources->text_border3 = ff277e;
	resources->text_border4 = 0x969696;
	resources->text_inactive_highlight = 0x707070;

	resources->bg_color = d40055;
	resources->default_text_color = ff80b2;
	resources->menu_title_text = ff80b2;
	resources->popup_title_text = ff80b2;
	resources->menu_item_text = ff80b2;
...
void PINKLADY::get_mwindow_sizes(MWindowGUI *gui, int w, int h)
{
	mbuttons_x = 0;
...
void PINKLADY::get_cwindow_sizes(CWindowGUI *gui, int cwindow_controls)
{
	if(cwindow_controls)
	{
SET_TRACE
...
void PINKLADY::get_recordgui_sizes(RecordGUI *gui, int w, int h)
{
	
}

void PINKLADY::get_rmonitor_sizes(int do_audio, 
	int do_video,
	int do_channel,
	int do_interlace,
	int do_avc,
...
void PINKLADY::get_vwindow_sizes(VWindowGUI *gui)
{
	vmeter_y = 5;
...
void PINKLADY::get_preferences_sizes()
{
}
...
void PINKLADY::get_new_sizes(NewWindow *gui)
{
}
...
void PINKLADY::get_plugindialog_sizes()
{
	int x = 10, y = 30;
