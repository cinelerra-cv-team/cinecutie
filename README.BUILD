...
The automake version of the cinecutie source tree needs third-party libraries
...
and the rest on http://www.kiberpipa.org/~minmax/cinecutie/builds/
(if not, please complain to cinecutie@skolelinux.no!)
...
util I made exception on source you need to manually apply
the patch to compile on distribution with libpng > 1.4.0:

 patch plugins/shapewipe/shapewipe.C png1.4patch/shapewipe.C.patch
 patch cinecutie/filepng.C png1.4patch/filepng.C.patch
