...
{
	return new ThemePinkMain(server);
}
...
ThemePinkMain::ThemePinkMain(PluginServer *server)
 : PluginTClient(server)
{
}

ThemePinkMain::~ThemePinkMain()
{
}

char* ThemePinkMain::plugin_title()
{
	return "Pink Theme";
}

Theme* ThemePinkMain::new_theme()
{
	theme = new ThemePink;
	extern unsigned char _binary_themepink_data_start[];
	theme->set_data(_binary_themepink_data_start);
	return theme;
}
...
void ThemePink::initialize()
{
	BC_Resources *resources = BC_WindowBase::get_resources();


	resources->text_default = 0xffffff;
	resources->text_background = 0x800033;
	resources->text_border1 = 0x592020;
	resources->text_border2 = 0x800033;
	resources->text_border3 = 0x800033;
	resources->text_border4 = 0x969696;
	resources->text_inactive_highlight = 0xbc55ac;

	resources->bg_color = 0xd40055;
	resources->default_text_color = 0xffffff;
	resources->menu_title_text = 0xffffff;
	resources->popup_title_text = 0xffffff;
	resources->menu_item_text = 0xffffff;
	...
	resources->menu_light = 0xd66d76;
	resources->menu_highlighted = 0x6f6f6f;
	resources->menu_down = 0x874b4b;
	resources->menu_up = 0x874b4b;
	resources->menu_shadow = 0x592020;
	resources->popupmenu_margin = 10;
	resources->popupmenu_triangle_margin = 15;

	resources->listbox_title_color = 0xffffff;

	resources->listbox_title_margin = 20;
	resources->listbox_title_hotspot = 20;
	resources->listbox_border1 = 0x4a1a1a;
	resources->listbox_border2 = 0x800033;
	resources->listbox_border3 = 0x800033;
	resources->listbox_border4 = 0x926464;
	resources->listbox_highlighted = 0x795050;
	resources->listbox_inactive = 0x800033;
	resources->listbox_bg = 0;
	resources->listbox_text = 0xffffff;

	resources->filebox_margin = 130;
	resources->file_color = 0xffffff;
...
void ThemePink::get_mwindow_sizes(MWindowGUI *gui, int w, int h)
{
	mbuttons_x = 0;
...
void ThemePink::get_cwindow_sizes(CWindowGUI *gui, int cwindow_controls)
{
	if(cwindow_controls)
	{
SET_TRACE
...
void ThemePink::get_recordgui_sizes(RecordGUI *gui, int w, int h)
{
	
}

void ThemePink::get_rmonitor_sizes(int do_audio, 
	int do_video,
	int do_channel,
	int do_interlace,
	int do_avc,
...
void ThemePink::get_vwindow_sizes(VWindowGUI *gui)
{
	vmeter_y = 5;
...
void ThemePink::draw_rwindow_bg(RecordGUI *gui)
{
// 	int y;
// 	int margin = 50;
// 	int margin2 = 80;
...
void ThemePink::draw_rmonitor_bg(RecordMonitorGUI *gui)
{
// 	int margin = 45;
// 	int panel_w = 300;
...
void ThemePink::draw_mwindow_bg(MWindowGUI *gui)
{
// Button bar
...
void ThemePink::draw_cwindow_bg(CWindowGUI *gui)
{
...
void ThemePink::draw_vwindow_bg(VWindowGUI *gui)
{
...
void ThemePink::get_preferences_sizes()
{
}


void ThemePink::draw_preferences_bg(PreferencesWindow *gui)
{
	gui->draw_vframe(get_image("preferences_bg"), 0, 0);
}

void ThemePink::get_new_sizes(NewWindow *gui)
{
}

void ThemePink::draw_new_bg(NewWindow *gui)
{
	gui->draw_vframe(get_image("new_bg"), 0, 0);
}

void ThemePink::draw_setformat_bg(SetFormatWindow *gui)
{
	gui->draw_vframe(get_image("setformat_bg"), 0, 0);
}


void ThemePink::get_plugindialog_sizes()
{
	int x = 10, y = 30;
